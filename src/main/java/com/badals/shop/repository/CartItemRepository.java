...
public interface CartItemRepository extends JpaRepository<CartItem, Long> {
   ...
   @Query(value="Select p.price, p.ref, p.title, c.quantity, p.image, p.weight, p.sku from cart_item c join product p on c.product_id = p.ref where c.cart_id = :id ", nativeQuery=true)

...
public interface OrderRepository extends JpaRepository<Order, Long> {
   ...
   @Query("from Order o where o.orderState <> ?3 and o.id between ?1 and ?2")
   List<Order> findByIdForMigration(Long from, Long to, OrderState exclude);
   ...
   @Query("select o from Order o left join fetch o.customer left join fetch o.orderItems oi left join fetch o.deliveryAddress left join fetch o.payments left join fetch o.cart where o.id = ?1 or o.reference= ?2 order by oi.sequence")

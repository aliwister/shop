...
public interface PurchaseRepository extends JpaRepository<Purchase, Long> {
   ...
   @Query(value="Select id, product_name as productName, outstanding as quantity, image, weight, price, url, sku, cost, order_id as orderId from purchase_queue", nativeQuery=true)

...
import com.badals.shop.web.rest.errors.EmailNotFoundException;
import com.badals.shop.web.rest.errors.InvalidPasswordException;
import com.badals.shop.web.rest.errors.LoginAlreadyUsedException;
...
/*    @GetMapping("/admin/activate")
    public void activateAccount(@RequestParam(value = "key") String key, @RequestParam(value = "email") String email) {
        Optional<User> user = userService.activateRegistration(key, email);
        if (!user.isPresent()) {
...
/*    @GetMapping("/admin/account")
    ...
    */}
     ...
     */
    @PostMapping(path = "/admin/account/change-password")
     ...
     */
/*    @PostMapping(path = "/admin/account/reset-password/init")
     ...
     */
/*    @PostMapping(path = "/admin/account/reset-password/finish")

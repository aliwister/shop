...
public class Test {
   ...
   private static final String SELLER_ID = "***REMOVED***";
   private static final String MARKETPLACE_ID = "***REMOVED***";
    ...
    public static Product getLowestOffer(String asin) {
        ...
        // Make the call.
        GetLowestOfferListingsForASINResponse response = Test.invokeGetLowestOfferListingsForASIN(client, request);
        return response.getGetLowestOfferListingsForASINResult().get(0).getProduct();
    }

    public static Product getMatchingProduct (String asin) {
       ...
       // Make the call.
       GetMatchingProductResponse response =  Test.invokeGetMatchingProduct(client, request);
    ...
    public static void main(String[] args) {
       ...
       // Create a request.
       GetLowestOfferListingsForASINRequest request = new GetLowestOfferListingsForASINRequest();
       String sellerId = "***REMOVED***";
       request.setSellerId(sellerId);
       String marketplaceId = "***REMOVED***";
       request.setMarketplaceId(marketplaceId);
       ASINListType asinList = new ASINListType();
       
       asinList.withASIN("B07JLBJZD4");
       ...
       // Make the call.
       Test.invokeGetLowestOfferListingsForASIN(client, request);
    ...
    public boolean printAmazonProduct(String asin) {
       ...
       product = Test.getMatchingProduct(asin);

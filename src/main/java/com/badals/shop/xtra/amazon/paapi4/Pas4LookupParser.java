...
public class Pas4LookupParser {
   ...
   public static MerchantStock parseStock(MerchantStock stock, PasItemNode i) throws PricingException, NoOfferException {
      ...
      BigDecimal cost = i.getCost();



      Double dCost = cost.doubleValue() * .01;
      ...
      BigDecimal price = PasUtility.calculatePrice(BigDecimal.valueOf(dCost), BigDecimal.valueOf(dWeight), localShipping, margin, risk, fixed, isPrime, isFulfilledByAmazon,"US");
